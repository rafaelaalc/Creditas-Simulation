...
class CreditSimulationServiceTest {
    ...
    @Test
    fun `#simulate must return a credit simulation successfully`() {
        val expectedResult = SimulationView.build()
        val simulationForm = SimulationForm.build()

        val result = creditSimulationService.simulate(simulationForm)
    ...
    @Test
    fun `#simulate should throw BadRequest exception when age is invalid`() {
        val simulationForm = SimulationForm.wrongAge()

        val exception = assertThrows<BadRequestException> {
            creditSimulationService.simulate(simulationForm)
        }
    ...
    @Test
    fun `#simulate should throw BadRequest exception when value is invalid`() {
    ...
    @Test
    fun `#simulate should throw BadRequest exception when payment term is invalid`() {
    ...
    @Test
    fun `#simulate should return correct interest rate for different birth dates`() {
        ...
        val result25 = creditSimulationService.simulate(simularionForm25)
        val result40 = creditSimulationService.simulate(simularionForm40)
        val result60 = creditSimulationService.simulate(simularionForm60)
        val result61 = creditSimulationService.simulate(simularionForm61)
